...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "yangfei"; // replace with your uniqname
    private static String password = "Fy200143"; // replace with your Oracle password (default: eecsclass)

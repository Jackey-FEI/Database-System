...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "mminjie"; // replace with your uniqname
    private static String password = "jtji160213"; // replace with your Oracle password (default: eecsclass)
